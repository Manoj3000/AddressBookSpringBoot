...
public class AddressBookController {
	...
	@GetMapping("/getUser")
	public ResponseEntity<Response> getUser(@RequestHeader long id) {
	...
	@PutMapping("/editUser")
	public ResponseEntity<Response> editUser(@RequestHeader long id, @RequestBody UserDTO user) {
	...
	public ResponseEntity<Response> deleteUser(@RequestHeader long id) {
